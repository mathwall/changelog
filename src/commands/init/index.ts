...
Hello and welcome! This folder has been automatically generated by \`pyproject-changesets\`.
...
export default async function init(cwd: string) {
  ...
  log(
    chalk`Thanks for choosing {green pyproject-changesets} to help manage your versioning and publishing\n`
  );
